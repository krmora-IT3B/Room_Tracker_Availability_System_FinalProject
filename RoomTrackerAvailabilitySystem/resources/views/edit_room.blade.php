...
@section('title', 'Edit Room - Room Tracker and Availability System')

@section('content')
<div class="mb-4">
    <h1 class="display-5 fw-bold">Edit Room</h1>
    <p class="text-muted">Update the room information or delete the room from the system.</p>
</div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-pencil-square me-2"></i>Edit Room Information</span>
                ...
                <form action="{{ route('rooms.update', $room->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('floor') is-invalid @enderror" id="floor" name="floor" required>
                                ...
                                <option value="Ground Floor" {{ old('floor', $room->floor) == 'Ground Floor' ? 'selected' : '' }}>Ground Floor</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('equipment') is-invalid @enderror" 
                                  ...
                                  placeholder="e.g., Whiteboard, Projector, Computers, Chairs, Aircon" required>{{ old('equipment', $room->equipment) }}</textarea>
                        @error('equipment')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
